...
then
	apt-get update
	apt-get install -y lsb_release wget curl git xvfb unzip libxrender1 libxtst6 libxi6 csh curl g++ make psmisc default-jdk poppler-utils python python-ipaddr bzip2 fontconfig lynx firefox
else
	yum update -y
